<?php
// all this appears to be python!

function testEncodesParameters() {
}

function testCreatesUrlsCorrectly() {
}

function testSetApiToken() {
}

function testSetACKey() {
}

function testACQuery() {
}
...
function testSearchNoRes() {
}

function testSearchRes() {
}

function testClickThrough() {
}
